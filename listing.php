...
// 高橋DBに合わせて配列を変更
$input_listing_data = ['product_name' => '' , 'img_extension' => '' ,  'price' => 0 , 'product_explain' => '' , 'product_category' => '' ,  'product_condition' => 0 , 'brand' => '' , 'days_to_ship' => 0 , 'cleaning_flg' => 0 , 'picking_flg' => 0, 'auto_approval_flg' => 0]; // 入力された情報をセットする配列
$err_msg = ['product_name' => '' , 'img_extension' => '' ,  'price' => '' , 'product_explain' => '' , 'product_category' => '' ,  'product_condition' => '' , 'brand' => '' , 'days_to_ship' => '' , 'cleaning_flg' => '' , 'picking_flg' => '', 'auto_approval_flg' => '']; // エラー出力用配列
$input_listing_label = ['product_name' => '商品名' , 'img_extension' => '画像' ,  'price' => '価格' , 'product_explain' => '商品説明' , 'product_category' => 'カテゴリ' ,  'product_condition' => '商品の状態' , 'brand' => 'ブランド' , 'days_to_ship' => '配送までの日数' , 'cleaning_flg' => 'クリーニングオプション' , 'picking_flg' => '集荷オプション', 'auto_approval_flg' => '購入申請自動許可']; // 添字に対するラベル名がセットされている配列
...
if(isset($_POST['listing'])){
    ...
    $file_name = './img/users/'.$user_id.'/pre/'.$input_listing_data['product_name'].'.'.$input_listing_data['img_extension'];
