  ...
  <main>
    <article>
      <section class="sec_product">
        <div>
          <img src="./img/users/2/products/1/product1.jpg" alt="商品画像サムネイル" width="80px" height="80px" />
        </div>
        <div>
          <p>
            アシメレースリボンニット（長袖）<br />
      ...
      <section>
        ...
        <p><button type="submit" class="btn btn_msg">メッセージ</button></p>
      </section>
      <div class="center">
        <a href="">返品を申請する</a><br />
        <a href="">問題を報告する</a>
      ...
      <div class="bg_btn_eval">
        <button type="submit" class="btn btn_eval">評価画面へ</button>
      </div>
    </article>
  </main>
</body>
