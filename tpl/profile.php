    ...
    <article>
      <section class="user-info">
        ...
        <div>
          ...
          <p class="user-confirm"><img src="./img/icon/本人確認.png" alt="本人確認バッジ" width="14px" height="16px" /><a
              href="">本人確認する</a></p>
        </div>
      ...
      <section id="products">
        ...
        <div>
          ...
          <img id="sold" class="<?php echo $product['listing_id'] == NULL ? "none" : ""; ?>"
            src="./img/icon/SOLDマーク(出品履歴一覧).svg" alt="">
        </div>
        <?php  endforeach; ?>
      </section>
    </article>
