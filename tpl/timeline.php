    ...
    <article>
      ...
      <section>
        <div class="post-div">
          ...
          <img class="menu" src="./img/icon/三点リーダーアイコン.svg" alt="メニューボタン" width="18px" height="18px">
        </div>
        <p class="post-sentence"><?php echo $product['post_sentence']; ?></p>

        <p class="listing-url">
          <a href="product_detail.php?id=<?php echo $product['listing_id']; ?>">
            <?php echo $product['product_name'] != NULL ? $product['product_name'] : ""; ?>
          </a>
        </p>
        <p class="post-img">
          <img
        ...
        <p class="action-btns">
          ...
          0
          <img src="./img/icon/返信アイコン.svg" alt="返信ボタン" width="20px" height="20px">0
        </p>
        <p>
      ...
      <a href="./post.php">
        <div class="post-btn">
          <img src="./img/icon/羽根ペンアイコン.svg" alt="" width="20px" height="24px">
        </div>
      </a>
      <a href="./top.php">
